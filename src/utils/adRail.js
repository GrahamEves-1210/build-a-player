...
// Returns the px the ad occupies from the bottom of the viewport, or 0 when
// it is hidden / collapsed / gone, or null when it exists but has no size yet.
...
export function watchAdRail() {
  ...
  function measure() {
    ...
    if (h === null) { apply(null); return }            // loading: CSS fallback covers it
