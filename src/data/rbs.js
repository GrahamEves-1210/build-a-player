...
const _RBS = [
  ...
  // BAL
  { name: 'Derrick Henry',          short: 'Henry',        team: 'BAL', teamName: 'Baltimore Ravens', skin: '#3a2010', height: 75, weight: 247, starter: true,  captain: true,  number: 22, attrs: { speed: 8, burst: 4, strength: 11, size: 11, balance: 9, hands: 4, vision: 9, elusiveness: 4,  carrying: 7 } },
  ...
  // DEN
  { name: 'J.K. Dobbins',           short: 'Dobbins',      team: 'DEN', teamName: 'Denver Broncos', skin: '#5e3c22', height: 69, weight: 219, starter: true,  captain: true,  number: 27, attrs: { speed: 7, burst: 7, strength: 7, size: 6, balance: 7, hands: 5, vision: 8, elusiveness: 6,  carrying: 10 } },
  ...
  // DET
  { name: 'Jahmyr Gibbs',           short: 'Gibbs',        team: 'DET', teamName: 'Detroit Lions', skin: '#5e3c22', height: 69, weight: 200, starter: true,  captain: true,  number: 26, attrs: { speed: 11, burst: 10, strength: 5, size: 5, balance: 7, hands: 8, vision: 8, elusiveness: 11,  carrying: 8 } },
  ...
  // MIA
  { name: "De'Von Achane",          short: 'Achane',       team: 'MIA', teamName: 'Miami Dolphins', skin: '#5e3c22', height: 69, weight: 188, starter: true,  captain: true,  number: 28, attrs: { speed: 11, burst: 10, strength: 2, size: 1, balance: 5, hands: 9, vision: 7, elusiveness: 8,  carrying: 7 } },
