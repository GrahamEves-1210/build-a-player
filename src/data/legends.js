...
const _raw = [
  ...
  },
  {
    ...
    attrs: { arm: 8, legs: 8, size: 8, processing: 5, vision: 6, leadership: 6, accuracy: 5, playmaking: 8, 'pocket-presence': 6 }
  },
...
export const QB_LEGEND_PHYSICALS = {
  'Aaron Rodgers':      { height: 74, weight: 225 },
  'Alex Smith':         { height: 75, weight: 217 },
  'Andrew Luck':        { height: 76, weight: 234 },
  'Andy Dalton':        { height: 74, weight: 220 },
  'Archie Manning':     { height: 74, weight: 212 },
  'Baker Mayfield':     { height: 73, weight: 215 },
  'Bart Starr':         { height: 73, weight: 200 },
  'Ben Roethlisberger': { height: 77, weight: 240 },
  'Bernie Kosar':       { height: 77, weight: 210 },
  'Blake Bortles':      { height: 77, weight: 232 },
  'Bob Griese':         { height: 73, weight: 190 },
  'Bobby Hebert':       { height: 76, weight: 215 },
  'Bobby Layne':        { height: 73, weight: 200 },
  'Boomer Esiason':     { height: 76, weight: 225 },
  'Brad Johnson':       { height: 75, weight: 226 },
  'Brett Favre':        { height: 74, weight: 222 },
  'C.J. Stroud':        { height: 75, weight: 214 },
  'Cam Newton':         { height: 77, weight: 245 },
  'Carson Palmer':      { height: 76, weight: 235 },
  'Chad Pennington':    { height: 75, weight: 224 },
  'Colin Kaepernick':   { height: 76, weight: 230 },
  'Dan Fouts':          { height: 75, weight: 210 },
  'Dan Marino':         { height: 76, weight: 224 },
  'Daunte Culpepper':   { height: 77, weight: 264 },
  'David Garrard':      { height: 74, weight: 234 },
  'Deshaun Watson':     { height: 74, weight: 215 },
  'Donovan McNabb':     { height: 74, weight: 240 },
  'Drew Bledsoe':       { height: 77, weight: 235 },
  'Drew Brees':         { height: 72, weight: 209 },
  'Eli Manning':        { height: 76, weight: 218 },
  'Fran Tarkenton':     { height: 72, weight: 190 },
  'Jake Delhomme':      { height: 75, weight: 215 },
  'Jake Plummer':       { height: 74, weight: 208 },
  'Jameis Winston':     { height: 75, weight: 231 },
  'Jared Goff':         { height: 76, weight: 222 },
  'Jay Cutler':         { height: 76, weight: 233 },
  'Jim Hart':           { height: 75, weight: 210 },
  'Jim Kelly':          { height: 75, weight: 225 },
  'Jim McMahon':        { height: 73, weight: 195 },
  'Jim Plunkett':       { height: 76, weight: 220 },
  'Jim Zorn':           { height: 74, weight: 200 },
  'Joe Burrow':         { height: 76, weight: 221 },
  'Joe Flacco':         { height: 78, weight: 245 },
  'Joe Montana':        { height: 75, weight: 200 },
  'Joe Namath':         { height: 76, weight: 200 },
  'Joe Theismann':      { height: 72, weight: 196 },
  'John Elway':         { height: 76, weight: 215 },
  'Johnny Unitas':      { height: 74, weight: 194 },
  'Josh Allen':         { height: 77, weight: 237 },
  'Justin Herbert':     { height: 78, weight: 236 },
  'Ken Anderson':       { height: 74, weight: 212 },
  'Ken Stabler':        { height: 74, weight: 215 },
  'Kerry Collins':      { height: 77, weight: 248 },
  'Kordell Stewart':    { height: 73, weight: 212 },
  'Kurt Warner':        { height: 74, weight: 214 },
  'Lamar Jackson':      { height: 74, weight: 212 },
  'Mark Brunell':       { height: 74, weight: 217 },
  'Mark Sanchez':       { height: 75, weight: 225 },
  'Matt Hasselbeck':    { height: 76, weight: 223 },
  'Matt Ryan':          { height: 76, weight: 217 },
  'Matt Schaub':        { height: 76, weight: 240 },
  'Matthew Stafford':   { height: 75, weight: 220 },
  'Michael Vick':       { height: 73, weight: 215 },
  'Nick Foles':         { height: 77, weight: 243 },
  'Otto Graham':        { height: 74, weight: 195 },
  'Patrick Mahomes':    { height: 75, weight: 230 },
  'Peyton Manning':     { height: 77, weight: 230 },
  'Phil Simms':         { height: 76, weight: 216 },
  'Philip Rivers':      { height: 77, weight: 228 },
  'Randall Cunningham': { height: 76, weight: 212 },
  'Rich Gannon':        { height: 74, weight: 210 },
  'Roger Staubach':     { height: 74, weight: 202 },
  'Roman Gabriel':      { height: 76, weight: 220 },
  'Russell Wilson':     { height: 71, weight: 215 },
  'Ryan Tannehill':     { height: 76, weight: 217 },
  'Sammy Baugh':        { height: 73, weight: 180 },
  'Sid Luckman':        { height: 73, weight: 195 },
  'Sonny Jurgensen':    { height: 72, weight: 202 },
  'Steve Bartkowski':   { height: 76, weight: 218 },
  'Steve Grogan':       { height: 75, weight: 210 },
  'Steve McNair':       { height: 75, weight: 230 },
  'Steve Young':        { height: 74, weight: 215 },
  'Terry Bradshaw':     { height: 74, weight: 215 },
  'Tom Brady':          { height: 76, weight: 225 },
  'Tony Romo':          { height: 75, weight: 230 },
  'Trent Dilfer':       { height: 76, weight: 236 },
  'Troy Aikman':        { height: 75, weight: 219 },
  'Vince Young':        { height: 77, weight: 232 },
  'Vinny Testaverde':   { height: 77, weight: 235 },
  'Warren Moon':        { height: 76, weight: 212 },
}
