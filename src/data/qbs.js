...
export const QBS = [
  ...
  { name: 'Bryce Young',        short: 'Young',       team: 'CAR', teamName: 'Carolina Panthers',     color: '#0085CA', color2: '#000000', skin: '#5e3c22', starter: true,  captain: true,  number: 9,
    attrs: { 'arm': 5, 'legs': 7, 'size': 0, 'processing': 6, 'leadership': 8, 'vision': 7, 'playmaking': 9, 'accuracy': 7, 'pocket-presence': 7 } },
  ...
  { name: 'Aaron Rodgers',      short: 'Rodgers',     team: 'PIT', teamName: 'Pittsburgh Steelers',   color: '#FFB612', color2: '#101820', skin: '#f0c0a0', starter: true,  captain: true,  number: 8,
    attrs: { 'arm': 8, 'legs': 3, 'size': 3, 'processing': 9, 'leadership': 6, 'vision': 9, 'playmaking': 5, 'accuracy': 8, 'pocket-presence': 9 } },
  ...
  { name: 'Brock Purdy',        short: 'Purdy',       team: 'SF',  teamName: 'San Francisco 49ers',   color: '#AA0000', color2: '#B3995D', skin: '#f0c4a0', starter: true,  captain: true,  number: 13,
    attrs: { 'arm': 5, 'legs': 7, 'size': 3, 'processing': 7, 'leadership': 7, 'vision': 8, 'playmaking': 8, 'accuracy': 6, 'pocket-presence': 9 } },
