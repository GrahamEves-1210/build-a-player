    ...
    <div className="about-page">
      <div className="about-inner">
        ...
        <div className="about-header">
          <div className="about-title">Build<em>-A-</em>Player Workshop</div>
        </div>

        <section className="about-section">
          <h2 className="about-section-title">What is this?</h2>
          <p className="about-body">
            Build-A-Player Workshop is an independent fan-made game that lets you construct the ultimate NFL quarterback by combining attributes from players across the league. Spin the wheel to land on a random team and QB, drag their stat onto your silhouette, and repeat until all 8 attribute slots are filled. Then simulate a full season to see how your Frankenstein QB stacks up.
          </p>
          <p className="about-body">
